...
/**
 * The <code>Converter</code> class implements the conversion of an MPEG audio file to a .WAV file. To convert an MPEG audio stream, just create an
 * instance of this class and call the convert() method, passing in the names of the input and output files. You can pass in optional
 * <code>ProgressListener</code> and <code>Decoder.Params</code> objects also to customize the conversion.
 *
 * @author MDM 12/12/99
 * @since 0.0.7
 */
public class Converter {
    ...
    /**
     * This interface is used by the Converter to provide notification of tasks being carried out by the converter, and to provide new information as
	 ...
	 *
	 *            UPDATE_FRAME_COUNT: param1 is the frame count, or -1 if not known. UPDATE_CONVERT_COMPLETE: param1 is the conversion time,
	 *            param2 is the number of frames converted.
	 */
	 ...
	 *
	 * @return <code>true</code> to continue processing, or false to abort conversion.
	 *
	 *         If this method returns <code>false</code>, the exception is propagated to the caller of the convert() method. If <code>true</code>
    ...
    /**
     * Implementation of <code>ProgressListener</code> that writes notification text to a <code>PrintWriter</code>.
     */
